...
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="petugas/homepetugas.php">UNIGA</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" href="petugas/datamahasiswa.php">Data Mahasiswa</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="petugas/datadosen.php">Data Dosen</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="petugas/datajurusan.php">Data Jurusan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="petugas/datajadwal.php">Jadwal Kuliah</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="petugas/datamatkul.php">Mata Kuliah</a>
              </li>
            </ul>
            <a href="petugas/logout.php" class="btn btn-primary">Logout</a>
        </div>
    </nav>
</header>
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="petugas/img/kamp.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="petugas/img/akuntansi.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="petugas/img/si.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
      </div>
</section>
    ...
    <div class="row">
        <div class="fakultas-kolom">
            ...
            <p> Mewujudkan fakultas yang unggul dan bermutu dalam pengembangan ilmu pengetahuan dan teknologi dan sumber daya manusia yang kompeten, 
                ...
                <p style="float: left;">       
                  <a href="petugas/datajurusan.php" class="btn btn-success">Data Jurusan</a>
              </p>
        </div>
        <div class="fakultas-kolom">
            <img src="petugas/img/mhs.jpg">
            ...
            <p> Terwujudnya Mahasiswa yang bermutu dan mampu bersaing di tingkat nasional dalam pengembangan ilmu, pendidikan, 
                ...
                <p style="float: left;">
                  <a href="petugas/datamahasiswa.php" class="btn btn-success">Data Mahasiswa</a>
              </p>
        </div>
        <div class="fakultas-kolom">
            <img src="petugas/img/dosen.jpg">
            ...
            <p>Pembelajaran ditunjang oleh dosen berkualitas dan didukung oleh dosen berkualifikasi Doktor (S-3) yang tidak saja kompeten secara akademis tetapi juga berpengalaman secara profesional dalam praktek. 
                ...
                <p style="float: left;">
                  <a href="petugas/datadosen.php" class="btn btn-success">Data Dosen</a>
              </p>
        </div>
        <div class="fakultas-kolom">
            <img src="petugas/img/psikologi.jpg">
            <h3>Jadwal Kuliah</h3>
            <p>Universitas Gajayana memiliki 13 pilihan program studi, yaitu Manajemen, Akuntansi, Ekonomi Pembangunan dan Perbankan, Bahasa Inggris, Psikologi, Ilmu Komunikasi, Sistem Informasi, Teknik Elektro, Teknik Mesin, Teknik/ Rekayasa Industri, Fisika, Magister Manajemen dan Magister Akuntansi. 
                ...
                <p style="float: left;">
                  <a href="petugas/datajadwal.php" class="btn btn-success">Data Jadwal Kuliah</a>
              </p>
        </div>
        <div class="fakultas-kolom">
            <img src="petugas/img/akuntansi.jpg">
            <h3>Mata Kuliah</h3>
            <p>Universitas Gajayana memiliki 13 pilihan program studi, yaitu Manajemen, Akuntansi, Ekonomi Pembangunan dan Perbankan, Bahasa Inggris, Psikologi, Ilmu Komunikasi, Sistem Informasi, Teknik Elektro, Teknik Mesin, Teknik/ Rekayasa Industri, Fisika, Magister Manajemen dan Magister Akuntansi.
                </p>
                <p style="float: left;">
                  <a href="petugas/datamatkul.php" class="btn btn-success">Data Mata Kuliah</a>
              </p>
        </div>
</section>
